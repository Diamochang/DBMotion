...
<div class="mdui-card mdui-center">
  <div class="mdui-card-content">
   <div class="mdui-textfield mdui-textfield-floating-label">
     ...
     <label class="mdui-textfield-label">网站特征码</label>
     <input id="sitecode" class="mdui-textfield-input" type="text">
     <div class="mdui-textfield-helper">请输入网站特征码以编辑/删除备案。</div>
   </div>
   <button class="mdui-btn mdui-btn-raised mdui-ripple mdui-color-theme-primary" onclick="btnClickEdit()">编辑</button>
   <button class="mdui-btn mdui-btn-raised mdui-ripple mdui-color-theme-primary" onclick="btnClickDel()">删除</button>
   <script>
        function btnClickEdit(){
            var text = document.getElementById('sitecode').value;
            window.location.href = "update.php?id=" + text;
        }
        function btnClickDel(){
            var text = document.getElementById('sitecode').value;
            window.location.href = "del.php?id=" + text;
        }
    </script>
  </div>
</div>
